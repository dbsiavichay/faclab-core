...
def test_get_all_movements_query_handler(mock_movement_repo):
    ...
    mock_movement_repo.get_all.return_value = movements
    ...
    mock_movement_repo.get_all.assert_called_once()
...
def test_get_all_movements_with_product_filter(mock_movement_repo):
    ...
    mock_movement_repo.filter_by.assert_called_once_with(product_id=1)
...
def test_get_all_movements_with_type_filter(mock_movement_repo):
    ...
    mock_movement_repo.filter_by.assert_called_once_with(type=MovementType.IN.value)
...
def test_get_all_movements_empty(mock_movement_repo):
    ...
    # Arrange
    mock_movement_repo.get_all.return_value = []
